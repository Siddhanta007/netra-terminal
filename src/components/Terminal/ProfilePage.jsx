...
export default function ProfilePage() {
  ...
  // Calculate some stats from tradeLogs
  ...
  return (
    <div className="flex-1 flex flex-col gap-8 animate-in fade-in zoom-in-95 duration-700 p-8 relative overflow-hidden">
      ...
      {/* Dynamic Grid Background (Aesthetic AI Look) */}
      <div 
      ...
      <div className="absolute top-[-100px] right-[-100px] w-80 h-80 bg-[#4169E1]/20 dark:bg-[#4169E1]/10 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[-100px] left-[-100px] w-80 h-80 bg-[#6366F1]/20 dark:bg-[#6366F1]/10 rounded-full blur-[100px] pointer-events-none"></div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="text-[9px] font-bold uppercase tracking-widest text-[var(--accent)] dark:text-white/40">
                Clearance: {session?.role || 'Standard Operator'}
              </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch relative z-10">
        ...
        {/* Left: Stats (NPU - Neural Processing Unit) */}
        <div className="lg:col-span-4 flex flex-col gap-6">
          
          {/* Glassmorphic Stat Card 1 */}
          <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)]/60 backdrop-blur-md flex flex-col gap-2 relative overflow-hidden group hover:border-[#4169E1]/50 transition-all duration-300 shadow-sm">
            <div className="absolute top-0 left-0 w-1 h-full bg-[#4169E1]"></div>
        ...
        {/* Right: Details & Operations (Instrument Grade Layout) */}
            ...
            <div className="space-y-8 flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[11px] font-bold font-mono text-emerald-500">{session?.id?.slice(0, 8) || 'N/A'}</span>
                </div>
              </div>
